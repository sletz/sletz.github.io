...
(async () => {
    ...
    //const { faustNode, dspMeta: { name } } = await createFaustNode(audioContext, "Atomicro", 0, true);
    const { faustNode, dspMeta: { name } } = await createFaustNode(audioContext, "Atomicro");
