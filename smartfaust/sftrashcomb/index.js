...
(async () => {
    ...
    // const result = await createFaustNode(audioContext, "sfTrashComb", FAUST_DSP_VOICES, true, 512);
    const result = await createFaustNode(audioContext, "sfTrashComb", FAUST_DSP_VOICES);
