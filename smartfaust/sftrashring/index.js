...
(async () => {
    ...
    // const result = await createFaustNode(audioContext, "sfTrashRing", FAUST_DSP_VOICES, true, 512);
    const result = await createFaustNode(audioContext, "sfTrashRing", FAUST_DSP_VOICES);
