...
(async () => {
    ...
    const { faustNode, dspMeta: { name } } = await createFaustNode(audioContext, "sinusoide", 0, true);
    //const { faustNode, dspMeta: { name } } = await createFaustNode(audioContext, "sinusoide");
