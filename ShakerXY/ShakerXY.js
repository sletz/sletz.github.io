...
(async () => {
    ...
    //const { faustNode, dspMeta: { name } } = await createFaustNode(audioContext, "ShakerXY", 0, true);
    const { faustNode, dspMeta: { name } } = await createFaustNode(audioContext, "ShakerXY");
